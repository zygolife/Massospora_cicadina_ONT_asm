...
DRAFT=$(realpath asm/tadpole_extend/flye_5FC_medaka_R8_scafRagtag/Masso.tadpole_round5.fasta.gz)
...
OUTDIR=asm/consensus_bbmap/flye_5FC_medaka_R8_scafRagtag_Tadpole
...
BAM=$OUTDIR/mapped_round${ROUND}.bam
VCF=$OUTDIR/Masso_illumina.round${ROUND}.vcf
CONS=$OUTDIR/Masso.bbcons_round${ROUND}.fasta
